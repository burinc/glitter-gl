(ns glitter-gl.renderer
  "GL realization of a declarative scene plan — the imperative seam.

  The scene is data (produced by glitter-gl.scene/flatten from a hiccup tree of
...
;; Shaders-as-data compiled by glitter-gl.shader — never raw GLSL strings.
