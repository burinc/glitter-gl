(ns glitter-gl.gl-test
  (:require [clojure.test :refer [deftest is testing]]))

;; glitter-gl.gl dlopens the host OpenGL library (:jolt/native in deps.edn) and
